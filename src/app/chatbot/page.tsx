...
import { Card, Input, Button, Avatar, Space, Spin, Typography, message as antMessage } from 'antd';
import { SendOutlined, UserOutlined, RobotOutlined, SafetyOutlined, WarningOutlined } from '@ant-design/icons';
